...
<body dir="rtl" style="margin:0;padding:0;background:#faf6f6;font-family:Arial,Helvetica,sans-serif;color:#1f2937;direction:rtl;text-align:right;">
        ...
        <div dir="rtl" class="email-card" style="background:#ffffff;border-radius:22px;overflow:hidden;border:1px solid #efe5e5;box-shadow:0 8px 30px rgba(163,42,42,.06);">
            ...
            <div dir="rtl" class="email-content" style="padding:24px;direction:rtl;text-align:right;">
                <div style="background:#fff;border:1px solid #efe5e5;border-radius:18px;padding:22px;margin-bottom:22px;">
                    <div style="font-size:23px;font-weight:700;margin-bottom:16px;text-align:center;color:#A32A2A;">تفاصيل الطلب</div>

                    <div style="display:block;">
                        <div style="padding:12px 0;border-bottom:1px solid #efe5e5;">
                            <span style="font-weight:700;">رقم الطلب:</span>
                            <span style="float:left;color:#A32A2A;font-weight:700;" dir="ltr">{{ $order->order_number }}</span>
                        </div>
                        <div style="padding:12px 0;border-bottom:1px solid #efe5e5;">
                        ...
                        <div style="padding:12px 0;border-bottom:1px solid #efe5e5;">
                            ...
                            <span style="float:left;color:#A32A2A;font-weight:700;">{{ $orderStatusLabel }}</span>
                        </div>
                ...
                <div style="background:#f9ebeb;border:1px solid #f0d1d1;border-radius:18px;padding:20px;margin-bottom:22px;">
                ...
                @if(!empty($order->notes))
                    <div style="background:#ffffff;border:1px solid #efe5e5;border-radius:18px;padding:18px;margin-bottom:22px;">
                        <div style="font-size:17px;font-weight:700;margin-bottom:8px;color:#A32A2A;">ملاحظات الطلب</div>
                        <div style="font-size:14px;color:#374151;white-space:pre-wrap;line-height:1.7;">{!! nl2br(e($order->notes)) !!}</div>
                    </div>
                @endif

                <div style="margin-bottom:22px;">
                    <div style="font-size:20px;font-weight:700;margin-bottom:14px;color:#A32A2A;">عناصر الطلب</div>

                    @foreach($orderItems as $item)
                        <div style="border:1px solid #efe5e5;border-radius:18px;background:#ffffff;padding:14px;margin-bottom:14px;direction:rtl;">
                            <table role="presentation" class="item-table" style="width:100%;border-collapse:collapse;">
                                <tr>
                                        ...
                                        @if(!empty($item['image_url']) || !empty($item['image_path']))
                                            ...
                                            @if($item['product_url'])
                                                <a href="{{ $item['product_url'] }}" target="_blank" style="text-decoration:none;">
                                                    <img src="{{ $resolvedItemImageSrc }}" alt="{{ $item['name'] }}" class="item-image" style="width:96px;height:96px;object-fit:cover;border-radius:14px;border:1px solid #efe5e5;display:block;">
                                                </a>
                                            @else
                                                <img src="{{ $resolvedItemImageSrc }}" alt="{{ $item['name'] }}" class="item-image" style="width:96px;height:96px;object-fit:cover;border-radius:14px;border:1px solid #efe5e5;display:block;">
                                            @endif
                                    ...
                                    <td style="vertical-align:top;">
                                        ...
                                        @endif
                                        <div style="font-size:16px;color:#A32A2A;font-weight:700;">الإجمالي: {{ number_format($item['total'], 2) }} شيكل</div>
                                        ...
                                        @if($item['product_url'])
                                            <div style="margin-top:10px;">
                                                <a href="{{ $item['product_url'] }}" target="_blank" style="display:inline-block;color:#A32A2A;text-decoration:none;font-weight:700;">عرض المنتج</a>
                                            </div>
                                        @endif
                                    </td>
                                </tr>
                ...
                <div style="background:#ffffff;border:1px solid #efe5e5;border-radius:18px;padding:20px;margin-bottom:22px;">
                    <div style="padding:10px 0;border-bottom:1px solid #efe5e5;">
                    ...
                    <div style="padding:10px 0;border-bottom:1px solid #efe5e5;">
                        ...
                        <span style="float:left;{{ (float) $order->shipping_cost === 0.0 ? 'color:#A32A2A;font-weight:700;' : '' }}">
                    ...
                    <div style="padding:14px 0 0;font-size:22px;font-weight:700;">
                        ...
                        <span style="float:left;color:#A32A2A;">{{ number_format((float) $order->total, 2) }} شيكل</span>
                    </div>
                </div>
                    ...
                    <table role="presentation" class="info-table" style="width:100%;border-collapse:separate;border-spacing:12px 0;">
                        <tr>
                            <td style="width:50%;vertical-align:top;">
                                <div style="background:#ffffff;border:1px solid #efe5e5;border-radius:18px;padding:20px;text-align:center;height:100%;">
                                    <div style="font-size:28px;margin-bottom:8px;">📞</div>
                                    <div style="font-size:18px;font-weight:700;margin-bottom:8px;color:#A32A2A;">تواصل معنا</div>
                                    <div style="font-size:14px;color:#6b7280;margin-bottom:12px;">لأي استفسارات حول طلبك</div>
                                    @if($headerPhone)
                                        <a href="tel:{{ preg_replace('/[^0-9+]/', '', $headerPhone) }}" style="color:#A32A2A;text-decoration:none;font-weight:700;" dir="ltr">{{ $headerPhone }}</a>
                                    @else
                                        <span style="color:#A32A2A;font-weight:700;">{{ $siteName }}</span>
                                    @endif
                                </div>
                            </td>
                            <td style="width:50%;vertical-align:top;">
                                <div style="background:#ffffff;border:1px solid #efe5e5;border-radius:18px;padding:20px;text-align:center;height:100%;">
                                    <div style="font-size:28px;margin-bottom:8px;">📦</div>
                                    <div style="font-size:18px;font-weight:700;margin-bottom:8px;color:#A32A2A;">تتبع الطلب</div>
                                    <div style="font-size:14px;color:#6b7280;margin-bottom:12px;">تابع حالة طلبك أول بأول</div>
                                    <a href="{{ $successUrl }}" target="_blank" style="color:#A32A2A;text-decoration:none;font-weight:700;">عرض صفحة الطلب</a>
                                </div>
                            </td>
                        </tr>
                    </table>
                ...
                <div style="text-align:center;margin-bottom:22px;">
                    <a href="{{ $frontendUrl }}/" target="_blank" class="action-link" style="display:inline-block;background:#A32A2A;color:#ffffff;text-decoration:none;padding:14px 24px;border-radius:14px;font-weight:700;margin-left:8px;">
                        العودة للرئيسية
                    </a>
                    <a href="{{ $frontendUrl }}/products" target="_blank" class="action-link" style="display:inline-block;border:1px solid #A32A2A;color:#A32A2A;text-decoration:none;padding:14px 24px;border-radius:14px;font-weight:700;">
                        متابعة التسوق
                    </a>
                </div>
